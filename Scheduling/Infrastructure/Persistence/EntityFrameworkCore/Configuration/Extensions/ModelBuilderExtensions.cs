...
public static class ModelBuilderExtensions
{
    public static void ApplySchedulingConfiguration(this ModelBuilder builder)
    {
        ...
        builder.Entity<Appointment>().Property(appointment => appointment.Id).IsRequired().ValueGeneratedNever();

        builder.Entity<Appointment>().Property(appointment => appointment.Code).IsRequired().HasMaxLength(50);
        builder.Entity<Appointment>().HasIndex(appointment => appointment.Code).IsUnique();
        builder.Entity<Appointment>().Property(appointment => appointment.DoctorId).IsRequired();
        builder.Entity<Appointment>().Property(appointment => appointment.PatientId).IsRequired();
        ...
        builder.Entity<AvailabilitySlot>().Property(slot => slot.Id).IsRequired().ValueGeneratedNever();

        builder.Entity<AvailabilitySlot>().Property(slot => slot.Code).IsRequired().HasMaxLength(50);
        builder.Entity<AvailabilitySlot>().HasIndex(slot => slot.Code).IsUnique();
        builder.Entity<AvailabilitySlot>().Property(slot => slot.DoctorId).IsRequired();
